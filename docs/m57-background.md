...
The dataset includes three main scenarios. We focused on **Exfiltration of Corporate Intellectual Property**, which centers on the suspicion that an employee has been passing proprietary research to an outside party. The original scenario document is available in [`exfiltration-scenario.pdf`](./M57-Patents-Exfiltration-Scenario.pdf).
